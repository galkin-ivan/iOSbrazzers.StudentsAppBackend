...
INSERT INTO tasks(id, date, description, priority, short_name, status, subject_id) VALUES
  (1, '25.11.2017', 'Парам-пам-пам Попов порам парам парам иос прогаем чтобы работало это описание задания это описание задания это описание задания', 2, 'Сделать дз2 по Попову', 0, 2),
  (2, '15.10.2017', 'ЗАПОЛНИ ЗАДАНИЯ ДЛЯ СЕБЯ, МАКЕТ Я СДЕЛАЛ, ТОЛЬКО ПОЛЯ МЕНЯЙ ОККУРАТНО, ЭТО ЛЕГКО СЛОМАТЬ', 2, 'Сделать дз1 по Попову', 0, 2),
  (3, '17.10.2017', '', 1, 'Подготовить фс Хартову', 0, 11),
  (4, '28.10.2017', '', 0, 'Сделать ЛР3 по шарпам', 0, 9),
  (5, '17.10.2017', '', 0, 'Поготовить презентацию по ТСиСА', 0, 7),
  (6, '05.11.2017', '', 1, 'Сделать дз2 по предпренимателю', 1, 8),
  (7, '12.12.2017', '', 2, 'Сделать дз2 по Гуренко', 0, 4),
  (8, '24.09.2017', '', 0, 'Сделать лр1 по шарпам', 0, 9),
  (9, '05.11.2017', '', 0, 'Сделать дз2 по экономике', 0, 6),
  (10, '07.10.2017', '', 0, 'Выбрать научрука', 0, 3),
  (11, '15.10.2017', '', 1, 'Сделать дз1 для Гуренко', 0, 4),
  (12, '25.12.2017', '', 2, 'Закончить разработку приложения', 0, 9),
  (13, '05.11.2017', '', 1, 'Сделать отчет к лр3 по Попову', 0, 2),
  (14, '17.10.2017', '', 0, 'Создать проект', 0, 9),
