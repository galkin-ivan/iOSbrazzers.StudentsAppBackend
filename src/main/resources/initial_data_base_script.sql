...
INSERT INTO activities(id, date, short_name, subject_id) VALUES
  (1, '2017-10-15', 'Рубежный контроль №1', 1),
  (2, '2017-10-27', 'Рубежный контроль №2', 1),
  (3, '2017-11-18', 'Рубежный контроль №2', 2),
  (4, '2017-10-27', 'Рубежный контроль №1', 4),
  (5, '2017-09-08', 'Рубежный контроль №1', 2),
  (6, '2017-01-25', 'Экзамен', 7),
  (7, '2017-10-28', 'Рубежный контроль №1', 8),
  (8, '2017-10-28', 'Рубежный контроль №3', 6)
  ;
...
INSERT INTO tasks(id, date, description, priority, short_name, status, subject_id) VALUES
  (1, '2017-11-25', 'Парам-пам-пам Попов порам парам парам иос прогаем чтобы работало это описание задания это описание задания это описание задания', 2, 'Сделать дз2 по Попову', 0, 2),
  (2, '2017-10-15', 'ЗАПОЛНИ ЗАДАНИЯ ДЛЯ СЕБЯ, МАКЕТ Я СДЕЛАЛ, ТОЛЬКО ПОЛЯ МЕНЯЙ ОККУРАТНО, ЭТО ЛЕГКО СЛОМАТЬ', 2, 'Сделать дз1 по Попову', 0, 2),
  (3, '2017-10-17', '', 1, 'Подготовить фс Хартову', 0, 11),
  (4, '2017-10-28', '', 0, 'Сделать ЛР3 по шарпам', 0, 9),
  (5, '2017-10-17', '', 0, 'Поготовить презентацию по ТСиСА', 0, 7),
  (6, '2017-11-05', '', 1, 'Сделать дз2 по предпренимателю', 1, 8),
  (7, '2017-12-12', '', 2, 'Сделать дз2 по Гуренко', 0, 4),
  (8, '2017-09-24', '', 0, 'Сделать лр1 по шарпам', 0, 9),
  (9, '2017-11-05', '', 0, 'Сделать дз2 по экономике', 0, 6),
  (10, '2017-10-07', '', 0, 'Выбрать научрука', 0, 3),
  (11, '2017-10-15', '', 1, 'Сделать дз1 для Гуренко', 0, 4),
  (12, '2017-12-25', '', 2, 'Закончить разработку приложения', 0, 9),
  (13, '2017-11-05', '', 1, 'Сделать отчет к лр3 по Попову', 0, 2),
  (14, '2017-10-17', '', 0, 'Создать проект', 0, 9),
  (15, '2017-10-28', '', 2, 'Подготовить что-нибудь для Хартова', 0, 3)
  ;
